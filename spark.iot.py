...
zk_broker = "10.65.3.73:2181"
kafka_topic = "iot"
group_id = "iot-sensor-consumer"
kudu_master = "10.65.3.73"
...
def getPrediction(p):
    ...
    return requests.post('http://cdsw.10.65.3.73.nip.io/api/altus-ds-1/models/call-model',
                       data='{"accessKey":"maih8xsdcvyzzkphqvu7ents57z13gel", "request":{"feature":"' + feature + '"}}',
...
#    kvs = KafkaUtils.createStream(ssc, zk_broker, group_id, {kafka_topic:1})
    kvs = KafkaUtils.createDirectStream(ssc, ['iot'], {"metadata.broker.list": "10.65.3.73:9092"})
