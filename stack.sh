...
CSP_BASE_URL=${CM_BASE_URL}/vault/CSP
CSP_PARCEL_REPO=${CSP_BASE_URL}/parcels/
SCHEMAREGISTRY_CSD_URL=${CSP_BASE_URL}/csd/2.0.1.0/SCHEMAREGISTRY-${SCHEMAREGISTRY_VERSION}.jar
STREAMS_MESSAGING_MANAGER_CSD_URL=${CSP_BASE_URL}/csd/2.0.1.0/STREAMS_MESSAGING_MANAGER-${STREAMS_MESSAGING_MANAGER_VERSION}.jar
